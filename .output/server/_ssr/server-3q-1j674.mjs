...
import { w as defineHandlerCallback, x as resolveManifestAssetLink, s as resolveManifestCssLink, j as rootRouteId, y as getNormalizedURL, z as getOrigin, A as waitForRequest, C as bindSsrResponseToRequest, D as normalizeSsrResponse, E as attachRouterServerSsrUtils, F as _getRenderedMatches, G as createSerializationAdapter, H as createRawStreamRPCPlugin, i as invariant, e as isNotFound, I as isRedirect, a as isDangerousProtocol, J as replaceSsrResponse, K as mergeHeaders, L as isSsrResponse, M as disposeSsrResponseDetached, N as executeRewriteInput, O as stripSsrResponseBody, P as defaultSerovalPlugins, Q as makeSerovalPlugin, p as getScriptPreloadAttrs, S as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C0Fm81u_.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-n4bYjCIt.mjs").then((n) => n.router),
    import("./start-afIYnRjI.mjs"),
